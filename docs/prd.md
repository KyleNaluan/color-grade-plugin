...
- Log profiles are pluggable objects (name, decode, gamut); V-Log and Rec.709 only for now. The profile's decode function is the single source of truth, consumed by both Decode LUT generation and analysis.
